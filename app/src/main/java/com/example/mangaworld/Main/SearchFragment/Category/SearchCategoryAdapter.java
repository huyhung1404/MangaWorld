...
import com.example.mangaworld.Extension.ValueInterpolator;
...
public class SearchCategoryAdapter extends RecyclerView.Adapter<SearchCategoryAdapter.SearchCategoryViewHolder> {
    ...
    public SearchCategoryAdapter(List<ListTagCategory> listTagCategories, Context context, SelectItemInRecycleView selectItemInRecycleView) {
    ...
    public SearchCategoryAdapter.SearchCategoryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new SearchCategoryViewHolder(view, (v, position) -> selectItemInRecycleView.onClickItemCategory(listTagCategories.get(position).getIdCategory(),false));
    }
