package com.example.mangaworld.Main.HomeFragment.RankFragment;
...
import com.example.mangaworld.Main.HomeFragment.RankFragment.RatingsFragment.RatingsFragment;
...
public class RankFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        viewPagerAdapter.AddFragment(new RatingsFragment(0, typeBXH, isLoadingApi), "bxh tổng");
        viewPagerAdapter.AddFragment(new RatingsFragment(30, typeBXH, isLoadingApi), "theo tháng");
        viewPagerAdapter.AddFragment(new RatingsFragment(7, typeBXH, isLoadingApi), "theo tuần");
